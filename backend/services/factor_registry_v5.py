...
FACTOR_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {"id": "us10y_change", "name": "美国10年期收益率", "layer": "leading", "source": "专业全球宏观API（待配置）", "source_level": "A", "ttl_minutes": 180, "lead_score": 0.9, "chains": ["long_rate_growth_valuation"]},
    {"id": "us2y_change", "name": "美国2年期收益率", "layer": "leading", "source": "专业全球宏观API（待配置）", "source_level": "A", "ttl_minutes": 180, "lead_score": 0.82, "chains": ["long_rate_growth_valuation"]},
    {"id": "vix_change", "name": "VIX波动率", "layer": "leading", "source": "专业全球行情API（待配置）", "source_level": "A", "ttl_minutes": 180, "lead_score": 0.78, "chains": ["currency_external_risk", "oil_geopolitics_inflation"]},
    {"id": "credit_pulse", "name": "信用脉冲", "layer": "leading", "source": "人民银行/国家统计局宏观API（待配置）", "source_level": "S", "ttl_minutes": 43200, "lead_score": 0.9, "chains": ["credit_cycle"]},
    {"id": "industry_price_signal", "name": "产业价格信号", "layer": "leading", "source": "行业价格/商品API（待配置）", "source_level": "A", "ttl_minutes": 1440, "lead_score": 0.78, "chains": ["industry_price_profit"]},
    {"id": "capex_signal", "name": "产业资本开支信号", "layer": "leading", "source": "公司财报PIT", "source_level": "A", "ttl_minutes": 10080, "lead_score": 0.72, "chains": ["capex_equipment_orders"]},
