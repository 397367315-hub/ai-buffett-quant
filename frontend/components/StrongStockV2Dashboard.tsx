...
export default function StrongStockV2Dashboard({ v2, symbol, onRefresh }: { v2: AnyMap; symbol?: string; onRefresh?: () => void }) {
  ...
  const zoneComparison = v2?.zone_comparison || {};
