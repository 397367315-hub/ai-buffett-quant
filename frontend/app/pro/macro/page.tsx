...
interface MacroData {
  ...
  cache_used: boolean;
  global_markets: Array<{ key: string; label: string; value: number | null; change_pct: number | null; currency: string; source_time: string | null; available: boolean; source: string }>;
