...
import { AlertTriangle, BrainCircuit, ClipboardList, LineChart, Loader2, MoonStar, Plus, Radio, Trash2, WalletCards } from 'lucide-react';
...
type TabId = 'strategies' | 'signals' | 'overnight' | 'backtest' | 'paper';
