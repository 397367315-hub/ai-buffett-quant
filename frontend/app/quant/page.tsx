...
import { AlertTriangle, BrainCircuit, ClipboardList, LineChart, Loader2, Plus, Radio, Trash2, WalletCards } from 'lucide-react';
...
type TabId = 'strategies' | 'signals' | 'backtest' | 'paper';
